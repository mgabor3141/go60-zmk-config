...
sed -i 's/PINNACLE_FEED_CFG2_EN_BTN_SCRL/PINNACLE_FEED_CFG2_EN_BTN_SCRL | PINNACLE_FEED_CFG2_DIS_GE/' /zmk/modules/cirque-input-module/drivers/input/input_pinnacle.c
